...
__all__ = [
    'vbextFileTypeBinary', '_Windows', 'CodePanes', 'VBComponents',
    'CodeModule', 'vbextFileTypeFrx', '_LinkedWindows',
    'vbext_rk_TypeLib', '_ProjectTemplate', 'vbextFileTypeProject',
    'SelectedComponents', 'vbext_pk_Get', '_ReferencesEvents',
    'vbext_ws_Minimize', 'vbext_wt_LinkedWindowFrame',
    'vbext_wt_ToolWindow', 'Windows', '_Properties', '_References',
    'CodePane', 'vbext_ProjectProtection', 'Events',
    '_VBProjects_Old', 'vbext_ct_Document', 'ProjectTemplate',
    'References', '_VBComponents', 'VBProject', 'vbext_ct_MSForm',
    'vbext_wt_Watch', 'vbext_WindowType', '_CodeModule',
    'VBComponent', 'vbext_ct_StdModule', 'VBProjects',
    'CommandBarEvents', 'vbextFileTypePropertyPage',
    'vbext_cv_ProcedureView', '_VBProjectsEvents', 'vbext_pk_Set',
    'vbext_wt_FindReplace', 'vbext_ProjectType', 'Application',
    '_Components', 'vbext_vm_Break', 'vbext_wt_Find',
    '_dispReferencesEvents', 'vbext_pp_locked',
    '_CommandBarControlEvents', 'vbext_ws_Maximize', 'Addins',
    'vbextFileTypeRes', 'vbextFileTypeForm', 'vbext_CodePaneview',
    '_dispVBComponentsEvents', 'vbext_ComponentType',
    'vbext_wt_Designer', '_AddIns', '_VBProject',
    '_dispReferences_Events', '_VBComponents_Old', 'vbext_wt_Locals',
    'vbext_wt_MainWindow', 'vbext_pt_StandAlone', 'vbext_pp_none',
    '_CodePanes', 'vbextFileTypeGroupProject', 'vbext_wt_Browser',
    'vbext_wt_Toolbox', 'vbext_wt_PropertyWindow', 'Window',
    'Components', 'vbext_wt_Immediate', 'Property', 'AddIn',
    'vbext_ct_ActiveXDesigner', 'vbext_pt_HostProject',
    '_VBProject_Old', 'ReferencesEvents', '_VBComponentsEvents',
    'vbextFileTypeDocObject', 'vbext_RefKind', 'vbextFileTypeClass',
    'vbext_ws_Normal', '_VBComponent', '_Component', 'Properties',
    'vbext_ProcKind', '_Windows_old', '_VBProjects',
    'vbextFileTypeExe', '_dispCommandBarControlEvents',
    'vbext_wt_ProjectWindow', 'vbext_cv_FullModuleView',
    'vbextFileTypeUserControl', 'vbextFileTypes', 'vbext_pk_Proc',
    'vbext_WindowState', '_CodePane', '_dispVBProjectsEvents',
    'vbext_ct_ClassModule', 'vbext_rk_Project', 'VBE',
    'vbext_wt_CodeWindow', 'LinkedWindows', '_VBComponent_Old',
    'vbextFileTypeModule', 'vbextFileTypeDesigners', 'Component',
    'vbext_vm_Run', 'vbext_vm_Design', 'vbext_VBAMode',
    'vbext_pk_Let', 'Reference'
]

_check_version('1.1.14', 1656078357.527622)
